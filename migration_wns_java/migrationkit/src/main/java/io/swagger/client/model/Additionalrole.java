...
public class Additionalrole {
	...
	/*
	 * public List<Primaryrole> getRoles() { return roles; }
	 * 
	 * public void setRoles(List<Primaryrole> roles) { this.roles = roles; }
	 * 
	 * 
	 * @Override public boolean equals(java.lang.Object o) { if (this == o) { return
	 * true; } if (o == null || getClass() != o.getClass()) { return false; }
	 * Additionalrole additionalrole = (Additionalrole) o; return
	 * Objects.equals(this.tenantId, additionalrole.tenantId) &&
	 * Objects.equals(this.roles, additionalrole.roles); }
	 * 
	 * @Override public int hashCode() { return Objects.hash(tenantId, roles); }
	 * 
	 * 

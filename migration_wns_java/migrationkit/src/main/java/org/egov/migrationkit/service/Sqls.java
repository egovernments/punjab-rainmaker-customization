...
public class Sqls {
	...
	public static final String WATER_CONNECTION_QUERY = "select json_build_object ( 'actualPipeSize', (select sizeininch from egwtr_pipesize psize where conndetails.pipesize=psize.id), "
